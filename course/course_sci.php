      ...
      <div class="col-lg-8">
        ...
        <article>
          ...
          <section class="mb-5 course-body">
            ...
            <p class="fs-6 mb-4 course-content"> ก่อนวันที่เริ่มเรียน 7 วัน </p>

            <h5 class="fw-bolder mb-4 mt-5" id="list-item-31"><i class="far fa-calendar-alt"></i> ช่วงเวลาเรียน</h5>
            <p class="fs-6 mb-4 course-content">วันที่ 23 - 24 กรกฎาคม 2565</p>

            <h5 class="fw-bolder mb-4 mt-5" id="list-item-32"><i class="far fa-clock"></i> ระยะเวลาของหลักสูตร </h5>
            <p class="fs-6 mb-4 course-content">หลักสูตรอบรม 15 ชั่วโมง (2 วัน)</p>
            ...
            <ul class="list-inline course-content fs-6">
              ...
              <li class="list-inline-item">ห้อง SC211 อาคารศูนย์วิทยาศาสตร์และวิทยาศาสตร์ประยุกต์</li>
            </ul>
            ...
            <ul class=" course-content fs-6 contact-course">
              <li><a href="../pdf/01.pdf" target="_blank" class="orange-theme-2">ดาวน์โหลด PDF</a> </li>
            </ul>
            ...
            <ul class="list-inline course-content fs-6 contact-course">
              <li class="list-inline-item"><i class="fas fa-phone-square-alt"></i> <a href="#">0656375524</a>
              </li>
            </ul>
      ...
      <div class="col-lg-4  d-none d-lg-block">
        ...
        <div id="list-example " class="list-group sticky-top ">
          ...
          <div class="my-3 card-rela">
            ...
            <li class="nav-item"><a class="nav-link" href="formEdit.php?cs_id=<?=$rs2['cs_id']?>" target="_blank">แก้ไข</a></li>
