        ...
        <div class="row">
            <div class="col-md-4"> <br>
                ...
                <form action="formAdd_db.php" method="post">
                    <div class="mb-1">
                        <label for="name" class="col-sm-2 col-form-label"> ลำดับ : </label>
                        <div class="col-sm-10">
                            <input type="text" name="id" class="form-control" required minlength="1"
                                placeholder="ลำดับ">
                        </div>
                    </div>
                    <div class="mb-1">
                    ...
                    <div class="mb-1">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="img" class="form-control" required minlength="1"
                                placeholder="รูปภาพ">
                        </div>
                    </div>
                    <div class="mb-1">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="date" class="form-control" required minlength="3"
                                placeholder="วันที่">
                        </div>
                    </div>
                    <div class="mb-1">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="price" class="form-control" required minlength="3"
